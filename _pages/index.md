...
+ [Feb 2021](/integrated-circuit-defect-diagnosis-using-machine-learning/) My patent on *Integrated circuit defect diagnosis using machine learning* is published
...
+ [Jan 2020](/learning-enhanced-diagnosis-of-logic-circuit-failures/) Defended my PhD thesis, [*Learning Enhanced Diagnosis of Logic Circuit Failures*](https://kilthub.cmu.edu/articles/thesis/Learning_Enhanced_Diagnosis_of_Logic_Circuit_Failures/11962164), Pittsburgh, PA, USA
...
+ [Apr 2019]{: .btn .btn--success} Semifinalist in the [TTTC’s E. J. McCluskey Best Doctoral Thesis Award Contest](http://tttc-vts.org/public_html/new/2019/doctoral-thesis-award/) held at the [VLSI Test Symposium (VTS)](http://tttc-vts.org/public_html/new/2019/), Monterey, CA, USA
...
+ [Feb 2019]{: .btn .btn--success} Check out our work, *An Automated Methodology for Logic Characterization Vehicle Design*, in the February 2019 issue of the [Electronic Design Failure Analysis (EDFA) Magazine](https://www.asminternational.org/web/edfas/news/edfa/-/journal_content/56/10192/36324098/MAGAZINE)
...
+ [Nov 2016](/logic-characterization-vehicle-design-reflection-via-layout-rewiring/){: .btn .btn--success} Check out our paper, *Logic characterization vehicle design reflection via layout rewiring*, at the [International Test Conference (ITC)](https://web.archive.org/web/20161207123429/http://www.itctestweek.org/), Fort Worth, TX, USA
